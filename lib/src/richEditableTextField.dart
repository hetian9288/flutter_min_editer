...
//class RichEditableTextField extends StatefulWidget {

/// Signature for the [RichEditableTextField.buildCounter] callback.
...
/// one of its ancestors to be a [Material] widget. When the [RichEditableTextField] is
/// tapped an ink splash that paints on the material is triggered, see
/// [ThemeData.splashFactory].
///
/// To integrate the [RichEditableTextField] into a [Form] with other [FormField] widgets,
/// consider using [TextFormField].
///
/// {@tool sample}
/// This example shows how to create a [RichEditableTextField] that will obscure input. The
...
class RichEditableTextField extends StatefulWidget {
  ...
  /// [RichEditableTextField.noMaxLength] then only the current length is displayed.
  ///
  ...
  /// to [RichEditableTextField.noMaxLength] then only the current character count is displayed.
  ///
  /// After [maxLength] characters have been input, additional input
  /// is ignored, unless [maxLengthEnforced] is set to false. The text field
  /// enforces the length with a [LengthLimitingTextInputFormatter], which is
  ...
  ///
  /// This value must be either null, [RichEditableTextField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [RichEditableTextField.noMaxLength], then no limit will
  ...
  @override
  _RichEditableTextFieldState createState() => _RichEditableTextFieldState();
...
class _RichEditableTextFieldState extends State<RichEditableTextField> with AutomaticKeepAliveClientMixin {
  ...
  @override
  void didUpdateWidget(RichEditableTextField oldWidget) {
