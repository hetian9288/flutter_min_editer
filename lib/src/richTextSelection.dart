...
export 'package:flutter/services.dart' show RichTextSelectionDelegate;
...
enum _RichTextSelectionHandlePosition { start, end }
...
typedef RichTextSelectionOverlayChanged = void Function(TextEditingValue value, Rect caretRect);
...
class RichTextSelectionOverlay {
	...
	void showHandles() {
		...
		_handles = <OverlayEntry>[
			OverlayEntry(builder: (BuildContext context) => _buildHandle(context, _RichTextSelectionHandlePosition.start)),
			OverlayEntry(builder: (BuildContext context) => _buildHandle(context, _RichTextSelectionHandlePosition.end)),
		];
	...
	Widget _buildHandle(BuildContext context, _RichTextSelectionHandlePosition position) {
		if ((_selection.isCollapsed && position == _RichTextSelectionHandlePosition.end) ||
						selectionControls == null)
			return Container(); // hide the second handle when collapsed
		return _RichTextSelectionHandleOverlay(
	...
	void _handleSelectionHandleChanged(TextSelection newSelection, _RichTextSelectionHandlePosition position) {
		TextPosition textPosition;
		switch (position) {
			case _RichTextSelectionHandlePosition.start:
				textPosition = newSelection.base;
				break;
			case _RichTextSelectionHandlePosition.end:
...
class _RichTextSelectionHandleOverlay extends StatefulWidget {
	const _RichTextSelectionHandleOverlay({
																			Key key,
	...
	final _RichTextSelectionHandlePosition position;
	final LayerLink layerLink;
	final RichRenderEditable renderObject;
	...
	@override
	_RichTextSelectionHandleOverlayState createState() => _RichTextSelectionHandleOverlayState();
...
class _RichTextSelectionHandleOverlayState
				extends State<_RichTextSelectionHandleOverlay> with SingleTickerProviderStateMixin {
	...
	@override
	void didUpdateWidget(_RichTextSelectionHandleOverlay oldWidget) {
	...
	void _handleDragUpdate(DragUpdateDetails details) {
		...
		if (widget.renderObject.supportRichText) {
